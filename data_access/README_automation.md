...
Edit line 12 in [schedule_daily_download.ps1](schedule_daily_download.ps1):
...
```powershell
# In schedule_daily_download.ps1, replace the Action creation with:
